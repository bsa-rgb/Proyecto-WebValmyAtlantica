...
<template>
  <section class="services">
    ...
    <div class="service-block">
      ...
      <h2>El sector energético seguirá cambiando. Eso es seguro.</h2>
      <p>Las empresas necesitan comprender su entorno energético para tomar decisiones con mayor seguridad. En Valmy Atlántica ayudamos a entender esa realidad con conocimiento, experiencia y un compromiso cercano cuando más se necesita.</p>
    </div>
